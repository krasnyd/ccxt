...
* jsDelivr: https://cdn.jsdelivr.net/npm/ccxt@4.4.92+queue.v2+queue.v1+queue.v1+queue.v1+queue.v1/dist/ccxt.browser.min.js
* unpkg: https://unpkg.com/ccxt@4.4.92+queue.v2+queue.v1+queue.v1+queue.v1+queue.v1/dist/ccxt.browser.min.js

CDNs are not updated in real-time and may have delays. Defaulting to the most recent version without specifying the version number is not recommended. Please, keep in mind that we are not responsible for the correct operation of those CDN servers.

```HTML
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/ccxt@4.4.92+queue.v2+queue.v1+queue.v1+queue.v1+queue.v1/dist/ccxt.browser.min.js"></script>
```
